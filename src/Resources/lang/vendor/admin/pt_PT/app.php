...
return [
    ...
    'sales' => [
        'orders' => [
            ...
            'create' => [
                ...
                'cart' => [
                    ...
                    'summary' => [
                        ...
                        'processing' => 'Processando',
                        'shipping-amount-excl-tax' => 'Valor do Portes de envio (Excl. Impostos)',
                        'shipping-amount-incl-tax' => 'Valor do Portes de envio (Incl. Impostos)',
                        'shipping-amount' => 'Valor do Portes de envio',
            ...
            'view' => [
                ...
                'shipping-and-handling-excl-tax' => 'Envio e Manuseamento (Excl. Impostos)',
                'shipping-and-handling-incl-tax' => 'Envio e Manuseamento (Incl. Impostos)',
        ...
        'shipments' => [
            'index' => [
                ...
                'datagrid' => [
                    'id' => 'ID',
                    'inventory-source' => 'Fonte de Stock',
                    'order-date' => 'Data do Pedido',
                    'order-id' => 'ID do Pedido',
        ...
        'refunds' => [
            ...
            'view' => [
                ...
                'refund' => 'Reembolso',
                'shipping-address' => 'Endereço de Entrega',
                'shipping-handling-excl-tax' => 'Envio e Manuseamento (Excl. Impostos)',
                'shipping-handling-incl-tax' => 'Envio e Manuseamento (Incl. Impostos)',
        ...
        'data-transfer' => [
            'imports' => [
                ...
                'import' => [
                    ...
                    'indexing-info' => 'Indexação de Recursos (Preço, Stock e Elasticsearch) em Progresso',
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'shipping-collected' => 'Cobrança de Portes de envio',
                'shipping-collected-over-time' => 'Cobrança de Portes de envio ao Longo do Tempo',
                'start-date' => 'Data de Início',
    ...
    'configuration' => [
        'index' => [
            ...
            'customer' => [
                ...
                'address' => [
                    'info' => 'Definir país, estado, Código Postal e linhas em um endereço de rua.',
                    'title' => 'Endereço',
            ...
            'sales' => [
                ...
                'shipping-methods' => [
                    'info' => 'Configurar os métodos de envio, incluindo Portes de envio Grátis, Portes de envio Fixo e outras opções conforme necessário.',
                    'title' => 'Métodos de Envio',

                    'free-shipping' => [
                        'description' => 'Descrição',
                        'page-title' => 'Portes de envio Grátis',
                        'status' => 'Status',
                        'title' => 'Título',
                        'title-info' => '"Portes de envio grátis" refere-se a um método de envio em que o custo do Portes de envio é isento, e o vendedor cobre as despesas de envio para entregar os produtos ao comprador.',
                    ],

                    'flat-rate-shipping' => [
                        'description' => 'Descrição',
                        'page-title' => 'Portes de envio Fixo',
                        'rate' => 'Taxa',
                        'status' => 'Status',
                        'title' => 'Título',
                        'title-info' => 'Portes de envio fixo é um método de envio em que uma taxa fixa é cobrada pelo envio, independentemente do peso, tamanho ou distância do pacote. Isso simplifica os custos de envio e pode ser vantajoso tanto para compradores quanto para vendedores.',
                        'type' => [
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'imports' => 'Importações',
                'inventory-sources' => 'Fontes de Stock',
                'invoices' => 'Faturas',
    ...
    'emails' => [
        ...
        'admin' => [
            'forgot-password' => [
                'description' => 'Está a receber este email porque recebemos um pedido de redefinição de Palavra-passe para a sua conta.',
                'greeting' => 'Esqueceu a Palavra-passe!',
                'reset-password' => 'Redefinir Palavra-passe',
                'subject' => 'Email de Redefinição de Palavra-passe',
            ],
        ],

        'customers' => [
            'registration' => [
                'description' => 'Uma nova conta de cliente foi criada com sucesso. Agora eles podem fazer login usando seu endereço de e-mail e credenciais de Palavra-passe. Uma vez logados, eles terão acesso a vários serviços, incluindo a capacidade de revisar pedidos anteriores, gerenciar listas de desejos e atualizar as informações de sua conta.',
