            ...
            'theme-customizations' => [
                ...
                'services-content' => [
                    'description' => [
                        ...
                        'free-shipping-info' => 'Aproveite o Portes de envio grátis em todos os pedidos',
                    ...
                    'title' => [
                        ...
                        'free-shipping' => 'Portes de envio grátis',
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'ready-for-installation' => [
                'create-database-tables' => 'Criar as tabelas da base de dados',
                'drop-existing-tables' => 'Remover tabelas existentes',
                'install' => 'Instalação',
                'install-info' => 'Bagisto Para Instalação',
                'install-info-button' => 'Clique no botão abaixo para',
                'populate-database-tables' => 'Popular as tabelas da base de dados',
            ...
            'start' => [
                ...
                'locale' => 'Local',
                'main' => 'Iniciar',
                'select-locale' => 'Selecionar Local',
                'title' => 'A sua instalação Bagisto',
                'welcome-title' => 'Bem-vindo ao Bagisto',
            ],
            ...
            'server-requirements' => [
                ...
                'curl' => 'cURL',
                'dom' => 'DOM',
                'fileinfo' => 'Informação de Ficheiro',
                'filter' => 'Filtro',
                'gd' => 'GD',
                'hash' => 'Hash',
                'intl' => 'Intl',
                ...
                'pdo' => 'PDO',
                'php' => 'PHP',
                'php-version' => ':version ou superior',
                'session' => 'Sessão',
            ...
            'back' => 'Voltar',
            'bagisto' => 'Bagisto',
            'bagisto-info' => 'um Projeto Comunitário por',
            'bagisto-logo' => 'Logótipo Bagisto',
            'bengali' => 'Bengali',
            'catalan' => 'Catalão',
            'chinese' => 'Chinês',
            'continue' => 'Continuar',
            ...
            'installation-info' => 'Estamos felizes por vê-lo aqui!',
