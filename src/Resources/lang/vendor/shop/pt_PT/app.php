...
return [
    'customers' => [
        'forgot-password' => [
            'already-sent' => 'E-mail de redefinição de Palavra-passe já enviado.',
            ...
            'forgot-password-text' => 'Se você esqueceu sua Palavra-passe, recupere-a inserindo seu endereço de e-mail.',
            'page-title' => 'Esqueceu sua Palavra-passe?',
            'reset-link-sent' => 'Enviamos o link de redefinição de Palavra-passe para o seu e-mail.',
        ...
        'reset-password' => [
            ...
            'submit-btn-title' => 'Redefinir Palavra-passe',
        ...
        'login-form' => [
            ...
            'email' => 'E-mail',
            'footer' => '© Copyright 2010 - :current_year, Webkul Software (Registrado na Índia). Todos os direitos reservados.',
            'forgot-pass' => 'Esqueceu a Palavra-passe?',
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'information' => [
                        ...
                        'shipping-handling' => 'Envio e Manuseamento',
                        'shipping-handling-excl-tax' => 'Envio e Manuseamento (Excl. Imposto)',
                        'shipping-handling-incl-tax' => 'Envio e Manuseamento (Incl. Imposto)',
                        'sku' => 'SKU',
                        'subtotal' => 'Subtotal',
                ...
                'invoice-pdf' => [
                    ...
                    'qty' => 'Quantidade',
                    'ship-to' => 'Enviar para',
                    'shipping-handling-excl-tax' => 'Portes de envio e Manuseamento (Excl. Imposto)',
                    'shipping-handling-incl-tax' => 'Portes de envio e Manuseamento (Incl. Imposto)',
                    'shipping-handling' => 'Portes de envio e Manuseamento',
                    'shipping-method' => 'Método de Envio',
                    'sku' => 'SKU',
                    'subtotal-excl-tax' => 'Subtotal (Excl. Imposto)',
                    'subtotal-incl-tax' => 'Subtotal (Incl. Imposto)',
        ...
        'checkout' => [
            ...
            'cart' => [
                ...
                'summary' => [
                    ...
                    'shipping-discount' => 'Desconto no Portes de envio',
                    ...
                    'estimate-shipping' => [
                        'country' => 'País',
                        'info' => 'Digite o destino para obter uma estimativa de Portes de envio e imposto.',
                        'postcode' => 'Código Postal',
                        'select-country' => 'Selecionar País',
                        'select-state' => 'Selecionar Estado',
                        'state' => 'Estado',
                        'title' => 'Estimar Portes de envio e Imposto',
                    ],
                ],
            ],
        ...
        'emails' => [
            ...
            'customers' => [
                'registration' => [
                    ...
                    'description' => 'Sua conta foi criada com sucesso e você pode fazer login usando seu e-mail e Palavra-passe. Ao fazer o login, você poderá acessar outros serviços, incluindo a revisão de pedidos anteriores, listas de desejos e a edição das informações da sua conta.',
                ...
                'forgot-password' => [
                    'description' => 'Você está recebendo este e-mail porque recebemos uma solicitação de redefinição de Palavra-passe para a sua conta.',
                    'greeting' => 'Esqueceu a Palavra-passe!',
                    'reset-password' => 'Redefinir Palavra-passe',
                    'subject' => 'E-mail de Redefinição de Palavra-passe',
                ],

                'update-password' => [
                    'description' => 'Você está recebendo este e-mail porque você atualizou sua Palavra-passe.',
                    'greeting' => 'Palavra-passe Atualizada!',
